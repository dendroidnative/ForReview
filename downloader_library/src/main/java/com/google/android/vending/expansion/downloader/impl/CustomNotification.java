...
public class CustomNotification implements DownloadNotification.ICustomNotification {
    ...
    public Notification.Builder updateNotification(Context c) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel channel = new NotificationChannel("Expansion", "Expansion", NotificationManager.IMPORTANCE_MIN);
            channel.setDescription("Expansion");
